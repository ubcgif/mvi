...
This file contains the cell property values associated with a model vector. The model objective function exponents (:math:`L_p / L_q`) can be designated throughout the mesh with this type of model file. The active cell file is also of this format (see below) The following is the file structure of the model file
